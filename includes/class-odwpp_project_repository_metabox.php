...
class Odwpp_Project_Repository_Metabox {
	...
	public static function admin_init() {
		add_meta_box(
			self::SLUG,
			__( 'Repozitář', Odwp_Projects_Plugin::SLUG ),
	...
	public static function render( $project ) {
		...
		ob_start();
		include( Odwp_Projects_Plugin::plugin_path( 'partials/metabox-project_repository.php' ) );
		$output = ob_get_clean();
...
endif; // Odwpp_Project_Repository_Metabox

if ( is_admin() ) {
	add_action( 'admin_init', array( 'Odwpp_Project_Repository_Metabox', 'admin_init' ) );
}