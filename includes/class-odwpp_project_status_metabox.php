...
class Odwpp_Project_Status_Metabox {
	const SLUG = 'odwp_project_status_metabox';
	...
	public static function admin_init() {
		add_meta_box(
			self::SLUG,
			__( 'Stav projektu', Odwp_Projects_Plugin::SLUG ),
	...
	public static function render( $project ) {
		...
		ob_start();
		include( Odwp_Projects_Plugin::plugin_path( 'partials/metabox-project_status.php' ) );
		$output = ob_get_clean();
